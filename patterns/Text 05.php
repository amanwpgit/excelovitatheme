...
<h2 class="wp-block-heading"><?php echo esc_html_e('Faster Workflow', 'excelovita-wp'); ?></h2>
<!-- /wp:heading -->

<!-- wp:list -->
<ul><!-- wp:list-item -->
<li><?php echo esc_html_e('Use pattern to build your website.', 'excelovita-wp'); ?></li>
<!-- /wp:list-item --></ul>
<!-- /wp:list -->
