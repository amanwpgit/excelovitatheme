...
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_theme_file_uri("assets/images/img_logo.png") ); ?>" alt="" class="wp-image-48" width="125" height="46"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:55%"><!-- wp:heading {"textAlign":"left","level":1} -->
<h1 class="wp-block-heading has-text-align-left"><?php esc_html_e( 'Best way to build a website', 'excelovita-wp' ); ?></h1>
<!-- /wp:heading -->
