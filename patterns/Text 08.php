...
<div class="wp-block-column"><!-- wp:list {"style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"var:preset|spacing|30"}}}} -->
<ul style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:var(--wp--preset--spacing--30)"><!-- wp:list-item -->
<li><?php esc_html_e( 'It is a long established fact', 'excelovita-wp' ); ?></li>
<!-- /wp:list-item --></ul>
<!-- /wp:list -->

<!-- wp:list {"style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"var:preset|spacing|30"}}}} -->
<ul style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:var(--wp--preset--spacing--30)"><!-- wp:list-item -->
<li><?php esc_html_e( 'It is a long established fact', 'excelovita-wp' ); ?></li>
<!-- /wp:list-item --></ul>
<!-- /wp:list -->
