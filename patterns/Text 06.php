...
<h2 class="wp-block-heading"><?php esc_html_e( 'You can easily change me', 'excelovita-wp' ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:column {"verticalAlignment":"bottom","style":{"spacing":{"blockGap":"var:preset|spacing|40"}}} -->
...
<div class="wp-block-column" style="padding-top:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--30)"><!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php esc_html_e( 'patterns', 'excelovita-wp' ); ?></h4>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'Replace any text, heading, sub heading or images with native WordPress builder.', 'excelovita-wp' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
